        ...
        <div className="flex flex-col md:flex-row items-center justify-between border-b pb-6">
            ...
            <div className="flex items-center">
              <div className="relative w-full">
                <input
                  ...
                  className="w-full border p-3 pl-10 rounded-md outline-none"
                />
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">@</span>
              </div>
              <button className="ml-4 bg-black text-white px-6 py-3 rounded-md">Join</button>
            </div>
          </div>
          {/* Right Part */}
          <div className="flex flex-col w-full md:w-1/2">
            ...
            <div className="flex space-x-4">
              <Link href="#"><FaFacebookF className="text-2xl cursor-pointer" /></Link>
              <Link href="#"><FaLinkedinIn className="text-2xl cursor-pointer" /></Link>
              <Link href="#"><FaTwitter className="text-2xl cursor-pointer" /></Link>
              <Link href="#"><FaInstagram className="text-2xl cursor-pointer" /></Link>
              <Link href="#"><FaPinterest className="text-2xl cursor-pointer" /></Link>
              <Link href="#"><FaTiktok className="text-2xl cursor-pointer" /></Link>
            </div>
          </div>
        </div>
      </div>
