  ...
  return (
    <div className="bg-gradient-to-t  from-blue-50 to-white py-8">
      <div className="w-[85%] mx-auto md:text-center">
        ...
        >
          Everyone benefits when notarizations are easy, legal, and can be
          checked more quickly. View our award-winning online notarization
          platform to learn how it is moving some of the biggest businesses in
          the country online. We can do the same for you.
        </motion.p>
