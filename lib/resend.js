...
export const sendContactEmail = async (name, email, message) => {
  try {
    const { data, error } = await resend.emails.send({
      from: "notaryblocks@notaryblocks.com", // Use the domain you've set up with Resend
...
export const sendBookingConfirmationEmail = async (
  ...
  await resend.emails.send({
    from: "info@notaryblocks.com",
    to: [recipientEmail],
    subject: "Appointment Confirmation - Notary Blocks",
    html: `
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f8f8f8;">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <img src="https://res.cloudinary.com/dlc04g2oh/image/upload/v1739861919/l_evqd0r.jpg" alt="Logo" width="150" style="display: block; margin: 0 auto;">
        </div>
            ...
            <tr>
                <td>
                    ...
                    <p style="font-size: 16px;">
                        We have received your appointment booking request. Thank you for choosing us.
                    </p>
                    ...
                    <p style="font-size: 16px;">
                        If you have any **urgent questions** or need assistance, feel free to reach out to our <a href="https://notaryblocks.com/contact"> support team </a>.
                    </p>
...
export const sendPaymentRequestEmail = async (
  ...
  await resend.emails.send({
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f8f8f8;">
        ...
        <!-- Logo Section -->
        <div style="text-align: center; margin-bottom: 20px;">
            <img src="https://res.cloudinary.com/dlc04g2oh/image/upload/v1739861919/l_evqd0r.jpg" alt="Company Logo" width="150" style="display: block; margin: 0 auto;">
        </div>
